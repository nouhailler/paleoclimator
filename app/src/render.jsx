      ...
      <div style={css(`padding:14px 14px 30px`)}>
        ...
        <div style={css(`display:flex;gap:8px;margin-top:9px`)}>
          <div style={css(`flex:1;background:#fff;border:1px solid #e0eaef;border-radius:11px;padding:10px 11px`)}>
            ...
            <div style={css(`font-family:'IBM Plex Mono',monospace;font-size:10px;color:#5b7688;margin-top:3px`)}>🧭 {v.rgnPaleoLatTxt}</div>
            <div style={css(`font-family:'IBM Plex Mono',monospace;font-size:11px;color:#d97a52;margin-top:2px`)}>🌡️ {v.rgnEpochTemp}</div>
          ...
          <div style={css(`flex:1;background:#fff;border:1px solid #e0eaef;border-radius:11px;padding:10px 11px`)}>
            ...
            <div style={css(`font-family:'IBM Plex Mono',monospace;font-size:10px;color:#5b7688;margin-top:3px`)}>🧭 {v.rgnTodayLatTxt}</div>
            <div style={css(`font-family:'IBM Plex Mono',monospace;font-size:11px;color:#d97a52;margin-top:2px`)}>🌡️ {v.rgnTodayTemp}</div>
